...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('FrontTemplate')}}/assets/img/favicon.ico" />
        ...
        <link href="{{asset('FrontTemplate')}}/css/styles.css" rel="stylesheet" />
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="{{asset('picture') . '/' . get_meta_value('foto')}}" alt="..." /></span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#interests">Hobby</a></li>
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-5">
                        {{get_meta_value('kota')}} · {{get_meta_value('provinsi')}} · {{get_meta_value('phone_number')}}
                        <a href="{{get_meta_value('email')}}">{{get_meta_value('email')}}</a>
                    </div>
                    ...
                    <div class="social-icons">
                        ...
                        <a class="social-icon" href="{{get_meta_value('twitter')}}"><i class="fab fa-twitter"></i></a>
            ...
            <section class="resume-section" id="experience">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">{{$item->new_start_date}} - {{$item->new_end_date}}</span></div>
                    </div>
                    @endforeach
                </div>
            </section>
        ...
        <!-- Core theme JS-->
        <script src="{{asset('FrontTemplate')}}/js/scripts.js"></script>
    </body>
</html>
